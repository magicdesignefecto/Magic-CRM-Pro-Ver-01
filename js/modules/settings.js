    ...
    render: async () => {
        ...
        return `
            <style>
                ...
                .settings-card { background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 16px; padding: 20px; box-shadow: var(--shadow-card); }
            ...
            <div class="settings-container">
                <div class="settings-grid">
                    ...
                    <div class="settings-card">
                        ...
                        <p style="color:var(--text-muted); font-size:0.85rem; margin-bottom:15px;">Descarga todo el historial de clientes en formato Excel.</p>
